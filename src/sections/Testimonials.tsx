...
const testimonials = [
   ...
   {
      text: "Our productivity has skyrocketed since we started using Blockfordge. It's a game-changer for our team.",
      name: 'Noel Baldwin',
      title: 'Lead Developer - BitBridge',
      avatarImage: '/assets/images/avatar-noel-baldwin.jpg'
   }, 
   {
      text: "The intergration process was seamless, and the performance are improvemenys are beyond uour expectations.",
      name: 'Harry Bender',
...
export const TestimonialsSection = () => {
   return (
      <section className="py-32 bg-zinc-800">
         ...
         <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 md:gap-8 lg:gap-8">
            {testimonials.map((testimonial, testimonialIndex) => (
                  ...
                  className={twMerge(
                     ...
                     <div className="flex gap-3 items-center">
                        <div>
                           <div className="size-16 bg-cover bg-zinc-700 rounded-full" style={{backgroundImage: `url(${testimonial.avatarImage})`}}>
                           </div>
                        </div>
                        <div>

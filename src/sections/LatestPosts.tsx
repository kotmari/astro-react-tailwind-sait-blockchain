   ...
   return (
      <section className="py-60">
         <div className="container">
            ...
            <p className="text-xl lg:text-2xl text-center text-zinc-400 mt-8">Keep up with the newest trends, updstes, and insights in the blockchain world, updated weekly.
            </p>
            </div>
            ...
            <motion.div className="hidden md:flex flex-col gap-8 mt-16" 
            style={{
               marginTop,
            }}
            ref={targetRef}>
